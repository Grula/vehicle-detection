...
if __name__ == '__main__':
    ...
    if not weights:
        ...
        weights_files = [f for f in os.listdir(args['model_dir']) if f.endswith('.h5')]
        ...
        while True:
            try:
                ...
                continue
    weights_path = os.path.join(args['model_dir'], weights)
    ...
    if not classes:
        ...
        classes_files = [f for f in os.listdir(args['model_dir']) if 'class' in f]
    ...
    classes_path = os.path.join(args['model_dir'], classes)
