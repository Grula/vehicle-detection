...
% Model je bio u mogućnosti da predvidi objekte na datim slikama za validaciju sa 6.8\% greške nadmašujući prvi naredni model za 0,9\%. \cite{simonyan2014very}. IZMENA (2.2-1), validacioni skup -> test
...
% IZMENA Dodao objasnjenje o resurismia
...
% IZMENA (5.4-3), objasnjenje zasto 512x512
...
% \begin{figure}[!htbp]
% \centering
%   \includegraphics[width=0.70\textwidth]{matfmaster/yolo/v4/BVSstandard_set/epoch_loss.png}
...
% \footnote{Za računanje prosečne preciznosti i srednje $F_1$-mere nije se koristila ocena pouzdanosti, već samo da li je objekat uspešno klasifikovan ili ne.}
...
% IZMENA ne uyima u obzir performulisati
